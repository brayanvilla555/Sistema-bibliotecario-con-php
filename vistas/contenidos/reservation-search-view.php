...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a class="active" href="<?= SERVER_URL?>reservation-search/"><i class="fas fa-search-dollar fa-fw"></i> &nbsp; BUSCAR POR FECHA</a>
        </li>
    </ul>
</div>
		...
		<table class="table table-dark table-sm">
			...
			<tbody>
				<tr class="text-center" >
					...
					<td>
						<a href="<?= SERVER_URL?>reservation-update/" class="btn btn-success">
