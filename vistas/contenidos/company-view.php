...
<?php
    ...
    if($datos_empresa->rowCount() == 0 && $_SESSION['privilegio_spm'] != 1):
?>
    <!--CONTENT-->
...
<?php
    elseif($datos_empresa->rowCount() == 1):
    ...
    <div class="container-fluid">
        <form class="form-neon FormularioAjax" action="<?= SERVER_URL?>ajax/empresaAjax.php" method="POST" data-form="save" autocomplete="off">
            <fieldset>
                ...
                <?php endif;?>
                <input type="hidden" name="empresa_id_up" id="empresa_id_up" value="<?=$loginControlador->encryption($campos['empresa_id'])?>">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="empresa_nombre" class="bmd-label-floating">Nombre de la empresa</label>
                                <input type="text" pattern="[a-zA-z0-9áéíóúÁÉÍÓÚñÑ. ]{1,70}" class="form-control" name="empresa_nombre_up" id="empresa_nombre" value="<?=$campos['empresa_nombre']?>" maxlength="70">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="empresa_email" class="bmd-label-floating">Correo</label>
                                <input type="email" class="form-control" name="empresa_email_up" id="empresa_email" value="<?=$campos['empresa_email']?>" maxlength="70">
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="empresa_telefono" class="bmd-label-floating">Telefono</label>
                                <input type="text" pattern="[0-9()+]{8,20}" class="form-control" name="empresa_telefono_up" id="empresa_telefono" value="<?=$campos['empresa_telefono']?>" maxlength="20">
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="empresa_direccion" class="bmd-label-floating">Dirección</label>
                                <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}" class="form-control" name="empresa_direccion_up" id="empresa_direccion" value="<?=$campos['empresa_direccion']?>" maxlength="190">
                            </div>
                        </div>
                    </div>
                </div>
