...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a class="active" href="<?= SERVER_URL?>item-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR ITEM</a>
        </li>
        <li>
...
<!--CONTENT-->
<div class="container-fluid">
	<form action="<?=SERVER_URL?>ajax/itemAjax.php" class="form-neon FormularioAjax" method="POST" enctype="multipart/form-data" data-form="save" autocomplete="off">
		<fieldset>
			<legend><i class="far fa-plus-square"></i> &nbsp; Información del item</legend>
			<div class="container-fluid">
				<div class="row">
					<input type="hidden" name="item_fecha_reg" id="item_fecha_reg" value="<?=date("Y-m-d")?>">
					<div class="col-12 col-md-4">
						<?php
							require_once 'modelos/mainModel.php';
							$ins_modelo = new mainModel();
							$codigo = $ins_modelo->generar_codigo_aleatorio("AB",7,rand(0,9));
						?>
						<div class="form-group">
							<label for="item_codigo" class="bmd-label-floating">Códido</label>
							<input type="text" pattern="[a-zA-Z0-9-]{1,45}" class="form-control" name="item_codigo_reg" id="item_codigo" value="<?= $codigo?>" maxlength="45">
						</div>
					</div>
					...
					<div class="col-12 col-md-6">
						<div class="form-group">
							<label for="articulo_imagen" class="bmd-label-floating">Imagen</label>
							<input type="file" class="form-control" name="item_imagen_reg" value="" id="item_imagen_reg">
						</div>
					</div>
					<div class="col-12 col-md-12">
						<div class="form-group">
							<label for="item_detalle" class="bmd-label-floating">Detalle</label>
							<input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,200}" class="form-control" name="item_detalle_reg" id="item_detalle" maxlength="190">
						</div>
					</div>
				</div>
			</div>
